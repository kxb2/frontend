...
// 메모 레이아웃
export const MEMO_WIDTH = 480;
export const MEMO_HEADER_PAD_X = 48;
const MEMO_HEADER_PAD_Y = 24;
export const MEMO_CONTENT_FONT_SIZE = 24;
export const MEMO_COUNTER_FONT_SIZE = 18;
export const MEMO_TITLE_FONT_SIZE = 24;
export const MEMO_HEADER_HEIGHT = MEMO_HEADER_PAD_Y * 2 + MEMO_TITLE_FONT_SIZE;
export const MEMO_BODY_PAD_X = 48;
export const MEMO_BODY_PAD_Y = 30;
export const MEMO_BODY_GAP = 15;
...
export const MEMO_CORNER_RADIUS: [number, number, number, number] = [18, 18, 0, 0];
export const MEMO_BODY_CORNER_RADIUS: [number, number, number, number] = [0, 0, 18, 18];
export const MEMO_ALL_CORNER_RADIUS: [number, number, number, number] = [18, 18, 18, 18]; // 접힘 모드
export const MEMO_BODY_BG = '#1c1f2a';
export const MEMO_TOGGLE_SIZE = 18;
// 메모 최소 너비
export const MEMO_MIN_WIDTH = 240;
export const MEMO_TITLE_MAX_CHARS = 40;
export const MEMO_HEADER_ICON_SCALE = 1.875;
...
// 새로 생성된 메모 높이 기본값
export const MEMO_DEFAULT_CONTENT_HEIGHT = Math.round(MEMO_CONTENT_FONT_SIZE * MEMO_LINE_HEIGHT * 2);
...
export function computeMemoScalePatch(item: MemoCanvasItem, sx: number) {
  const width = Math.max(MEMO_MIN_WIDTH, (item.width ?? MEMO_WIDTH) * sx);
